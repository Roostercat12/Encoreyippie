...
// Villains
	...
	#define is_archdevillackey(mind) (mind.has_antag_datum(/datum/antagonist/archdevilcultist))
	#define is_archdevilcultist(mind) (mind.has_antag_datum(/datum/antagonist/archdevilcultist/leader))
