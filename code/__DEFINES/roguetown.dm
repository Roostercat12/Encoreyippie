...
#define ALL_PROFANE_PATRONS 	list(/datum/patron/inhumen/archdevils, /datum/patron/inhumen/envy, /datum/patron/inhumen/deceivers, /datum/patron/inhumen/hertannea, /datum/patron/angros/extremist)
...
#define CTAG_YEOMAN "CTAG_YEOMAN"
