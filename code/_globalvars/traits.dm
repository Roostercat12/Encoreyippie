...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"Eyes of Deceivers" = TRAIT_DECEIVERS_EYES,
		...
		"Member of the Katholikon's Inquisition" = TRAIT_INQUISITION,
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_ASSASSIN = "My soul has been tainted by Archdevils, god of murder.",
	TRAIT_BARDIC_TRAINING = "Iliope's inspiration grants my songs boons and ailments.",
	TRAIT_GRAVEROBBER = "Valdala favors my grim deeds, I can unearth graves without being cursed by her.",
	...
	TRAIT_DEATHSIGHT = span_info("I can feel when someone nearby draws Valdala's attention, a tiny voice whispering 'Someone has died,' in my ear."),
	...
	TRAIT_CABAL = span_purple("My blood is empowered by the One Envy, and I instinctively know of others of the cult."),
	TRAIT_CABAL_CHUD = span_purple("I'm a faithful follower of the Jealous God, and I recognise others part of Her cult!"),
	...
	TRAIT_INQUISITION = span_info("I am a member of the Katholikon's Inquisition. I can easily identify others of my cadre at a glance."),
	TRAIT_SILVER_BLESSED = span_info("I am anointed with holy silver, which preserves me from bitten curses. Miracles not of Angros hold no sway over me."),
	TRAIT_DECEIVERS_EYES = span_notice("I have a sense for what the most valuable item someone has is."),
	...
	TRAIT_DREAM_WATCHER = span_notice("I'm blessed by Akan, my dreams tell more than the average person.."),
	...
	TRAIT_ANGROSIAN = span_info("ANGROS LIVES. ANGROS PERSISTS. I can ENDURE and LIVE with wounds better than most."),
	TRAIT_ANGROSIAN_GRIT = span_info("I can shrug off my wounds and maintain composure under duress. My own mortality is proof that I LIVE, as too does HE."),
	...
	TRAIT_SORCERER = SPAN_GOD_AKAN("I am a sorcerer, unable to wield magickal tomes but gifted with innate power."),
))
