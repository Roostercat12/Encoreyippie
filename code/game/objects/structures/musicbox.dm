...
/obj/structure/fake_machine/musicbox
	...
	desc = "A marvelous device created by Dunnish artificers, it plays a variety of songs from across the Goblet, as if their performers were within the same room."
