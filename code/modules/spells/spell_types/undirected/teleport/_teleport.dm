...
/datum/action/cooldown/spell/undirected/teleport
	...
	var/post_teleport_sound

/datum/action/cooldown/spell/undirected/teleport/cast(atom/cast_on)
	. = ..()
...
/datum/action/cooldown/spell/undirected/teleport/proc/get_destinations(atom/center)
...
/datum/action/cooldown/spell/undirected/teleport/proc/is_valid_destination(turf/selected)
...
/datum/action/cooldown/spell/undirected/teleport/radius_turf/get_destinations(atom/center)
...
/datum/action/cooldown/spell/undirected/teleport/radius_turf/is_valid_destination(turf/selected)
	. = ..()
	if(!.)
		return FALSE
...
/datum/action/cooldown/spell/undirected/teleport/area_teleport/get_destinations(atom/center)
	var/list/valid_turfs = list()
...
/datum/action/cooldown/spell/undirected/teleport/area_teleport/before_cast(atom/cast_on)
	. = ..()
	...
	if(randomise_selection)
		...
		target_area = browser_input_list(cast_on, "Chose an area to teleport to.", "Teleport", GLOB.teleportlocs)
...
/datum/action/cooldown/spell/undirected/teleport/area_teleport/cast(atom/cast_on)
	if(isliving(cast_on))
		var/mob/living/living_cast_on = cast_on
		living_cast_on.buckled?.unbuckle_mob(cast_on, force = TRUE)
	return ..()

/datum/action/cooldown/spell/undirected/teleport/area_teleport/invocation()
