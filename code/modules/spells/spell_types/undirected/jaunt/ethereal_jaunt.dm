...
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/cast(mob/living/cast_on)
	. = ..()
	do_jaunt(cast_on)
 ...
 * - if jaunt_out_time = 0
 */
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/proc/do_jaunt(mob/living/cast_on)
 ...
 * Calls start_jaunt.
 */
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/proc/do_jaunt_out(mob/living/cast_on, obj/effect/dummy/phased_mob/spell_jaunt/holder)
 ...
 */
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/proc/start_jaunt(mob/living/cast_on, obj/effect/dummy/phased_mob/spell_jaunt/holder)
	if(QDELETED(cast_on) || QDELETED(holder) || QDELETED(src))
		return
 ...
 */
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/proc/stop_jaunt(mob/living/cast_on, obj/effect/dummy/phased_mob/spell_jaunt/holder, turf/start_point)
	if(QDELETED(cast_on) || QDELETED(holder) || QDELETED(src))
		return
 ...
 * Calls end_jaunt.
 */
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/proc/do_jaunt_in(mob/living/cast_on, obj/effect/dummy/phased_mob/spell_jaunt/holder, turf/final_point)
	if(QDELETED(cast_on) || QDELETED(holder) || QDELETED(src))
		return
 ...
 */
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/proc/end_jaunt(mob/living/cast_on, obj/effect/dummy/phased_mob/spell_jaunt/holder, turf/final_point)
	if(QDELETED(cast_on) || QDELETED(holder) || QDELETED(src))
		return
	ADD_TRAIT(cast_on, TRAIT_NO_TRANSFORM, "[REF(src)]")
	exit_jaunt(cast_on)
 ...
 */
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/proc/update_exit_point(mob/living/source)
	SIGNAL_HANDLER
...
/datum/action/cooldown/spell/undirected/jaunt/ethereal_jaunt/proc/do_steam_effects(turf/loc)
