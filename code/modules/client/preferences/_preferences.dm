...
/datum/preferences
	...
	/// job.title -> list("title" = chosen_value, "honorary" = chosen_value)
...
/datum/preferences/New(client/C)
	...
	if(!read_preference(/datum/preference/choiced/patron))
		write_preference(/datum/preference/choiced/patron, GLOB.patron_list[/datum/patron/divine/gani])
...
/datum/preferences/proc/reset_patron(mob/user, silent = FALSE)
	write_preference(/datum/preference/choiced/patron, /datum/patron/divine/gani)
	if(!silent)
