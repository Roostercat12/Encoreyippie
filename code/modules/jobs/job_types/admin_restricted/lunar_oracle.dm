...
/datum/outfit/oracle
	...
	beltl = /obj/item/weapon/flail/silver
...
/mob/living/carbon/human/proc/oracleannouncement()
	...
	if(stat)
		return
	if(!istype(get_area(src), /area/indoors/town/church))
		to_chat(src, "<span class='warning'>I need to do this from the church.</span>")
		return FALSE
