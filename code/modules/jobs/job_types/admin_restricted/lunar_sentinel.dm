...
/datum/job/admin/lunar_sentinel
	...
	tutorial = "You are a devoted follower of Akan. \
	Sentinel of the Lunar Order you serve the agents of The court of Air. \
	Keep safe the nite."
...
/datum/job/admin/lunar_sentinel/on_roundstart(mob/living/spawned, client/player_client)
	...
	var/static/list/selectable = list(
		"Moonlight Khopesh" = /obj/item/weapon/sword/sabre/akan,
		"Lunar Flail" = /obj/item/weapon/flail/silver,
	)
...
/datum/outfit/lunar_sentinel
	...
	neck = /obj/item/clothing/neck/gorget/gold
