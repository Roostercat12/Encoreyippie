...
/datum/job/jester
	...
	tutorial = "The Cudese were known for their Jesters, wisemen with a tongue just as sharp as their wit. \
...
// Ear Trick! Pull objects from behind someone's ear by the will of Iliope!
