/mob/living/simple_animal/hostile/spirit_vengeance
	name = "rancor spirit"
...
/mob/living/simple_animal/hostile/spirit_vengeance/get_sound(input)
	switch(input)
		if("laugh")
...
/mob/living/simple_animal/hostile/spirit_vengeance/Initialize(mapload)
	. = ..()
