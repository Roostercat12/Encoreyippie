...
/mob/living/simple_animal/hostile/retaliate/troll/broodmother
	name = "Broodmother"
	desc = "Once, Pomette gifted to Archdevil the Luxus Pragmas and told him to make a female companion with it.\
			He was supposed to make a beautiful and courageous wife from it, is what Pomette had hoped he would do.\
			Instead, Archdevil created this."
...
/mob/living/simple_animal/hostile/retaliate/troll/broodmother/proc/frenzy_on()
	...
	playsound(src, 'sound/misc/gods/omen_fire.ogg', 80, extrarange = SHORT_RANGE_SOUND_EXTRARANGE, frequency = 32000)
